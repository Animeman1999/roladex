...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <link href="Content/editperson.css" rel="stylesheet" />
    <div class ="title text-center"><h3>Edit or Delete a Contact</h3></div>
  
    <%-- GridView used for editing and deleting contacts --%>
    <div class="row">
